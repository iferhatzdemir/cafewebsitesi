<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?=SITE?>" class="brand-link">
      <img src="<?=SITE?>dist/img/logo.png" alt="Trigo Fırın Cafe" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">Trigo Fırın Cafe</span>
    </a>
