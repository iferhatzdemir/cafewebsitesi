...
<head>
  ...
  <link rel="stylesheet" href="<?=SITE?>plugins/summernote/summernote-bs4.css">
   ...
   <link rel="icon" type="image/png" href="img/mfp.ico">
...
swalWithBootstrapButtons.fire({
  ...
  if (result.isConfirmed) {
    window.location.href='silici.php?ID=';ID;
  } else if (
...
<script>$(function(){
     $(".silmeAlani").click(function(e){
       ...
       swal({
        ...
        text: "Bu veriyi sildiğinizde bir daha geri alamıcaksınız.",
        icon: "warning",
        buttons: true,
        dangerMode: true,
      })
