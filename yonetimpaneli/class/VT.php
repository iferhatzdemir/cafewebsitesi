...
class VT{
	...
	public function MailGonder($mail,$konu="",$mesaj)
	{
		...
		$posta->CharSet = "UTF-8";
				...
				$posta->Host     = 	"mail.trigofirin.com"; // SMTP servers
				$posta->SMTPAuth = true;     // turn on SMTP authentication
				$posta->Username = "info@trigofirin.com";  // SMTP username
				$posta->Password = "F3rh4t32."; // SMTP password
				$posta->Port     = 993; 
				$posta->From     = "info@trigofirin.com"; // smtp kullanýcý adýnýz ile ayný olmalý
				$posta->Fromname = "info@trigofirin.com";
				$posta->AddAddress($mail, "info@trigofirin.com");
				$posta->Subject  =  $konu;
				$posta->Body     =  $mesaj;
