            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <?php
					$veriler=$VT->VeriGetir("kategoriler","","","ORDER BY ID DESC");
                      foreach($veriler as $item){
						  if($urunBilgisi[0]["kategori"]==$item["ID"]){
							echo '<option selected value="'.$urunBilgisi[0]["kategori"].'">'.$item["baslik"].'</option>';
						  }
                        echo '<option value="'.$item["ID"].'">'.$item["baslik"].'</option>';
                      }
                    ?>
					</select>
            </div>
