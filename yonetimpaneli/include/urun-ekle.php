...
<div class="content-wrapper">
  ...
  <section class="content">
    <div class="container-fluid">
      ...
      if($_POST)
      {
       if(!empty($_POST["kategori"]) && !empty($_POST["baslik"]) && !empty($_POST["anahtar"]) && !empty($_POST["description"]) && !empty($_POST["sirano"])  && !empty($_POST["metin"])  )
       {
        ...
        if($yukle!=false)
        {
          ...
          $ekle=$VT->SorguCalistir("INSERT INTO urunler","SET baslik=?, seflink=?, kategori=?, metin=?,  resim=?, anahtar=?, description=?,  durum=?, sirano=?, tarih=?,fiyat=?",array($baslik,$seflink,$kategori,$metin,$yukle,$anahtar,$description,1,$sirano,date("Y-m-d"),$fiyat));
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="col-md-12">
                <div class="form-group">
                  <label>Fiyat</label>
                  <input type="text" class="form-control" placeholder="Fiyat Giriniz ..." name="fiyat">
                </div>
              </div>
